...
class ManagementHandler:
    ...
    def _setup_logging(self, event_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            audit_result["event_id"] = self._generate_deterministic_deterministic_build_helpers.deterministic_deterministic_build_helpers.deterministic_deterministic_build_helpers.deterministic_hash(event_content)[:16]

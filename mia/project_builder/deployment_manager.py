...
class DeploymentManager:
    ...
    def __init__(self, deployments_dir: str = "./deployments"):
        ...
        self.deployments_dir.mkdeterministic_build_helpers._get_deterministic_dir(exist_ok=True)
    ...
    def deploy_project(self, project_path: str, deployment_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info(f"🚀 Deploying project: {project_path.name}")
            ...
            self.logger.info(f"✅ Deployment completed: {project_path.name}")
...
''')
    ...
    def _run_deployment_step(self, step_name: str, command: List[str], cwd: Path,
        ...
        try:
            ...
            process_result = deterministic_build_helpers.deterministic_run(
                command,
                cwd=cwd,
                capture_output=True,
                text=True,
            ...
            if process_result.returncode != 0 and not optional:
                result["success"] = False
                raise deterministic_build_helpers.deterministic_calledProcessError(

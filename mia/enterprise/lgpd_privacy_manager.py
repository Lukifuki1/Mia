...
class LGPDPrivacyManager:
    ...
    def process_data_subject_request(self, 
        ...
        try:
            request_id = f"dsr_{int(self._get_build_timestamp().timestamp())}"
            ...
            request_record = {
                ...
                "response": response,
                "processed_at": self._get_build_timestamp().isoformat(),
                "status": "completed"
            }
        ...
        for proc_id, proc_data in self.processing_activities.items():
            if proc_data.get("data_subject_id") == data_subject_id:
                ...
                if "updates" in request_details:
                    ...
                    proc_data["last_updated"] = self._get_build_timestamp().isoformat()

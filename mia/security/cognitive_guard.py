...
class CognitiveGuard:
    ...
    """Cognitive Guard za zaščito zavestnih procesov"""
    ...
    def start_monitoring(self):
        ...
        self.logger.info("🧠 Cognitive Guard monitoring started")
    ...
    def stop_monitoring(self):
        ...
        self.logger.info("🧠 Cognitive Guard monitoring stopped")
    ...
    def validate_llm_output(self, output: str) -> bool:
        ...
        try:
            ...
            # Preveri za škodljive vzorce v output-u
            harmful_patterns = [
                r'<script[^>]*>',
                r'javascript:',
                r'eval\s*\(',

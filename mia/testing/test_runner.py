...
class TestRunner:
    ...
    def run_comprehensive_tests(self) -> Dict[str, Any]:
        ...
        try:
            ...
            test_execution_results["execution_time"] = self._get_build_epoch() - start_time
            ...
            self.logger.info(f"✅ Test execution completed: {test_execution_results['total_tests_run']} tests run")
    ...
    def _run_performance_tests(self) -> Dict[str, Any]:
        ...
        try:
            ...
            fs_scan_time = self._get_build_epoch() - start_time
